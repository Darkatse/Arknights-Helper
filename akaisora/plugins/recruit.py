...
class NormalStaffData:
    sixList = ['推进之王','能天使','星熊','闪灵','伊芙利特','银灰','塞雷娅','夜莺','艾雅法拉','陈','安洁莉娜','斯卡蒂','黑','赫拉格','麦哲伦','莫斯提马']
    fiveList =['幽灵鲨','芙兰卡','德克萨斯','凛冬','白面鸮','蓝毒','普罗旺斯','雷蛇','临光','红','赫默','夜魔','初雪','拉普兰德','华法琳','守林人','狮蝎','真理','白金','陨星','梅尔','可颂','崖心','空','食铁兽','诗怀雅','格劳克斯','星极','送葬人','槐琥','苇草','布洛卡']
    fourList = ['深海色','杜宾','白雪','流星','梅','远山','夜烟','蛇屠箱','末药','猎蜂','慕斯','砾','暗索','地灵','调香师','清道夫','霜叶','角峰','古米','缠丸','阿消','红豆','杰西卡','格雷伊','苏苏洛','桃金娘','红云']
